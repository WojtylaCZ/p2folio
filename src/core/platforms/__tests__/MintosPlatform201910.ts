...
import * as mintosResult from '../../../../examples/mintos-account-statement.json';
import { MintosPlatform } from '../MintosPlatform';

it('validates SUM total numbers', () => {
  const rawFile = fs.readFileSync(path.join(__dirname, `../../../../examples/mintos-account-statement.xlsx`));

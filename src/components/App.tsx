    ...
    return (
      <div>
        ...
        <div className="content">
          <p>
            <b>
              P2folio vám zobrazí na výsledky z jednotlivých platforem na měsíšní bázi. Zároveň umí zkombinovat výsledky dohromady
              pro historický vývoj celého potfolia. Sjednocuje tak data z různých P2P platforem pro kompaktní statistiky a přehled
              P2P portfolia.
            </b>
          </p>
          <p>
          ...
          <p>
            <b>
              Vaše data jsou v bezpečí jen u vás v prohlížeči. Vše je anonymní, data se nikam se neodesílají, služba nemá žádnou
              další část.
              <br />
